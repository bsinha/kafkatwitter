...
public class KafkaAvroConsumerV1 {
	...
	private static final String KAFKA_GROUP_ID = "my-avro-consumer";
	...
	public static KafkaConsumer<String, Customer> createConsumer(final String topic) {
		...
		final KafkaConsumer<String, Customer> kafkaConsumer = new KafkaConsumer<String, Customer>(configs);
